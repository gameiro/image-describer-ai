...
socketio = SocketIO(app, cors_allowed_origins='*', logger=True, engineio_logger=True, secure=True)
...
if __name__ == '__main__':
    socketio.run(app, debug=True, host='0.0.0.0', port=int(os.environ.get('PORT', 8080)), ssl_context='adhoc')
